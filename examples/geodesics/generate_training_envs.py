...
if __name__ == "__main__":
    if True:
        ...
        g = SceneGenerator(dataset_path=DATASET_PATH, num=NUM_TRAIN, name=level_name,
                stage="stages/box_2", keep_in_bounds=[
                CylinderGenerator(base_center=[0., 0., 1.5], radius=10., height=2.,
                    dataset_path=DATASET_PATH, object_set="primitives/unit/unit_cube",
                    scale_rng=Uniform([0.2, 5., 2.], [0., 0., 0.]),
                    rotation_rng=Uniform([0., 0., 0.], [0.2, 0.2, 3.14]),
                    density=0.03, 
                    seed=42
                )], keep_out_bounds=[
                CylinderGenerator(base_center=[0., 0., 0.], radius=2.5, height=5.)
        ])
        g.generate()
        ...
        g = SceneGenerator(dataset_path=DATASET_PATH, num=NUM_EVAL, name=level_name,
                stage="stages/box_2", keep_in_bounds=[
                CylinderGenerator(base_center=[0., 0., 1.5], radius=10., height=2.,
                    dataset_path=DATASET_PATH, object_set="primitives/unit/unit_cube",
                    scale_rng=Uniform([0.2, 5., 2.], [0., 0., 0.]),
    ...
    if True:
        ...
        g = SceneGenerator(dataset_path=DATASET_PATH, num=NUM_TRAIN, name=level_name,
                ...
                CylinderGenerator(base_center=[0., 0., 1.5], radius=10., height=2.,
                    dataset_path=DATASET_PATH, object_set="primitives/unit/unit_cube",
                    scale_rng=Uniform([0.2, 5., 4.], [0., 0., 0.]),
                    rotation_rng=Uniform([0., 0., 0.], [0.2, 0.2, 3.14]),
                    density=0.03,
                    seed=42
                )], keep_out_bounds=[
    ...
    if True:
        ...
        g = SceneGenerator(dataset_path=DATASET_PATH, num=NUM_TRAIN, name=level_name,
                stage="stages/box_2", keep_in_bounds=[
                CylinderGenerator(base_center=[0., 0., 0.], radius=10., height=5.,
                    dataset_path=DATASET_PATH, object_set="primitives/unit/unit_cube",
                    scale_rng=Uniform([1.5], [0.]),
                    rotation_rng=Uniform([0., 0., 0.], [0.5, 0.5, 0.5]),
                    density=0.03,
                    seed=42
                )], keep_out_bounds=[
                CylinderGenerator(base_center=[0., 0., 0.], radius=2.5, height=5.)
    ...
    if True:
        ...
        g = SceneGenerator(dataset_path=DATASET_PATH, num=NUM_TRAIN, name=level_name,
                stage="stages/box_2", keep_in_bounds=[
                CylinderGenerator(base_center=[0., 0., 0.], radius=10., height=5.,
                    dataset_path=DATASET_PATH, object_set="primitives/unit/unit_cylinder_vertical",
                    scale_rng=Uniform([0.75, 8., 0.75], [0.5, 0.0, 0.5]),
                    rotation_rng=Uniform([0., 0., 0.], [0.5, 0.5, 0.5]),
                    density=0.03,
                    seed=42
                )], keep_out_bounds=[
    ...
    if True:
        ...
        g = SceneGenerator(dataset_path=DATASET_PATH, num=NUM_TRAIN, name=level_name,
                stage="stages/box_2", keep_in_bounds=[
                CylinderGenerator(base_center=[0., 0., 0.], radius=10., height=5.,
                    dataset_path=DATASET_PATH, object_set="primitives/medium",
                    scale_rng=Uniform([1.], [0.2]),
                    rotation_rng=Uniform([0., 0., 0.],[3., 3., 3.]),
                    density=0.13, 
                    seed=42
                )], keep_out_bounds=[
                CylinderGenerator(base_center=[0., 0., 0.], radius=2.5, height=5.)
    ...
    if True:
        ...
        g = SceneGenerator(dataset_path=DATASET_PATH, num=NUM_TRAIN, name=level_name,
                ...
                CylinderGenerator(base_center=[0., 0., 0.], radius=10., height=5.,
                    ...
                    seed=42),
                CylinderGenerator(base_center=[0., 0., 0.], radius=10., height=5.,
                    dataset_path=DATASET_PATH, object_set="primitives/small",
                    scale_rng=Uniform([1.], [0.2]),
                    rotation_rng=Uniform([0., 0., 0.],[3., 3., 3.]),
                    density=0.1, 
                    seed=42)
